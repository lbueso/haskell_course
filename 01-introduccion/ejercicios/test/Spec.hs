...
main = hspec $ do
  describe "Ejercicios de introduccion" $ do
    it "pruebas de head..." $ do
      property $ (prop_f_list :: List_to_e) Lib.head Prelude.head
    it "pruebas de tail..." $ do
      property $ (prop_f_list :: List_to_list_i) Lib.tail Prelude.tail
    it "pruebas de last..." $ do
      property $ (prop_f_list :: List_to_e) Lib.last Prelude.last
